                    ...
                    <article className="group flex flex-col h-full bg-[#FBF4E8] rounded-2xl overflow-hidden hover:shadow-xl transition-shadow duration-500">
                      <Link href={`/products/${product.slug}`} className="block">
                        <div className="relative aspect-square w-full overflow-hidden bg-[#F5E9DA]">
                          ...
                          />
                          <span className="absolute top-3 left-3 text-xs font-semibold tracking-wide text-[#C17A2A] bg-white/90 backdrop-blur-sm px-3 py-1.5 rounded-full">
                            {product.category}
                          </span>
                        </div>
                      </Link>
                      <div className="flex flex-col flex-grow p-5 sm:p-6">
                        <Link href={`/products/${product.slug}`} className="block">
                          <div className="flex items-start justify-between gap-2 mb-2">
                            <h3 className="font-poppins text-lg sm:text-xl font-semibold text-[#2C1500] group-hover:text-[#C17A2A] transition-colors leading-tight">
                              {product.name}
                            </h3>
                            <span className="text-xs font-semibold tracking-wide text-[#C17A2A] bg-[#C17A2A]/10 px-2.5 py-1 rounded-full shrink-0">
                              {product.weight}
                            </span>
                          </div>
                          <p className="text-[#2C1500]/55 text-sm sm:text-base leading-relaxed mb-5 flex-grow">
                            {product.description}
                          </p>
                        </Link>
                        <div className="flex items-center justify-between mt-auto pt-4 border-t border-[#2C1500]/10">
                          <p className="font-poppins text-lg sm:text-xl font-bold text-[#2C1500]">
                            {product.price}
                          </p>
                          <button
