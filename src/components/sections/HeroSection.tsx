  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-20 px-6 overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-5xl mx-auto flex flex-col items-center mt-12">
        ...
        <HeroButtonWrapper>
          <a href="#products" className="group px-10 py-4 bg-white text-black hover:bg-black hover:text-white text-xs md:text-sm tracking-[0.2em] uppercase transition-all duration-500 inline-flex items-center gap-4">
