...
export default function TrustBanner() {
  return (
    <section className="py-16 bg-[#F4F1ED] text-black">
      <div className="max-w-[1440px] mx-auto px-6">
        <ZoomIn>
          <div className="text-center mb-10">
            <h3 className="font-poppins text-lg md:text-xl font-medium tracking-[0.2em] uppercase">{data.trustBanner.title}</h3>
          </div>
        </ZoomIn>
