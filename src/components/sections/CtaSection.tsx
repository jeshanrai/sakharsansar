...
export default function CtaSection() {
  return (
    <section id="contact" aria-label="Call to Action" className="py-32 sm:py-40 px-6 bg-black text-white relative flex flex-col items-center justify-center min-h-[50vh] sm:min-h-[60vh]">
      <div className="max-w-5xl mx-auto text-center relative z-10 w-full">
        <ZoomIn>
          <div className="flex flex-col items-center justify-center">
            ...
            <button onClick={() => openOrderDrawer()} className="group inline-flex items-center gap-6 px-10 sm:px-12 py-4 sm:py-5 bg-white text-black text-xs font-semibold tracking-[0.2em] uppercase hover:bg-[#F4F1ED] transition-colors">
