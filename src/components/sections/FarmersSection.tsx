  ...
  return (
    <section className="py-32 px-6 bg-[#F4F1ED]">
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="flex gap-12 overflow-x-auto pb-12 snap-x scrollbar-hide">
            ...
            <SlideInRight key={i} delay={i * 0.1} className="min-w-[85vw] md:min-w-[600px] snap-center">
              <div className="bg-white group cursor-default h-full border border-black/10 flex flex-col md:flex-row">
                ...
                <div className="p-12 md:w-1/2 flex flex-col justify-center">
                  ...
                  <p className="text-black/70 font-light leading-relaxed italic text-sm">"{farmer.story}"</p>
                </div>
              </div>
            </SlideInRight>
          ))}
